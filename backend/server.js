...
const API_KEY = process.env.APPSETTING_EXCHANGE_API_KEY || process.env.EXCHANGE_API_KEY;
...
app.use(cors({
  origin: [
    'https://jolly-sand-01e679a03.2.azurestaticapps.net',
    'https://conv.sanfi.xyz'
  ],
}));
